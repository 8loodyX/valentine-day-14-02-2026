...
🌐 **Live Demo**: You can check out the live version of this project at [https://github.com/8loodyx/. Easily host it on **GitHub Pages** and send the link to your loved one for a sweet surprise! 💕
...
1. Clone this repository:
   ```bash
   git clone https://github.com/8loodyx/
   ```
...
---
💖 Made with love by [Mohammad Suzon](https://github.com/8loodyx/).
